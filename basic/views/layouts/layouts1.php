            ...
            <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                <div class="contact-row">
                    <div class="phone inline">
                        <i class="fa fa-phone"></i>1232132134
                    </div>
                    <div class="contact inline">
                        <i class="fa fa-envelope"></i>myshop@<span class="le-color">our.com</span>
                    </div>
                </div><!-- /.contact-row -->
                <!-- ============================================================= SEARCH AREA ============================================================= -->
                        ...
                        <div class="control-group">
                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown">
                                    ...
                                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">分类</a>
                                ...
                                <div class="total-price-basket">
                                    <span class="lbl">购物车:</span>
                                        <span class="total-price">
                                            <span class="sign">$</span><span class="value">3200</span>
                                        </span>
                                </div>
                            </a>
